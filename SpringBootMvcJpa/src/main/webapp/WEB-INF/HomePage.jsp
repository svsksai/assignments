...
<nav class="col-md-10 mx-auto alert alert-primary row">
	...
	<div class="m-2"><a class="btn btn-danger" href="viewbyid">View by ID</a></div>
	<div class="m-2"><a class="btn btn-danger" href="viewbydept">View by Dept</a></div>
	<div class="m-2"><a class="btn btn-danger" href="showaddform">Add Employee</a></div>
